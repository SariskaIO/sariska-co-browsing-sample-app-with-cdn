# Sariska Co-Browsing Integration with Pomodoro App via CDN
...
Note: Currently, co-browsing starts automatically on page load. You can also initiate co-browsing by clicking a button. Use the 'startCobrowsing' and 'stopCoBrowsing' methods, as written in App.js. Also ,Check index.html for co-browsing CDN script URL.
